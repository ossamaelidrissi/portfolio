...
const Resume = ({ data }) => {
  if (data) {
    ...
    const education = [{
      ...
      graduated: "July 2021",
      school: "LSTA Developement Informatique SidiYossef - Morocco"
    }]
    ...
    var work = data.work.map(function (work) {
      return (
        <div key={work.company}>
          ...
          <p>Build the application for the clients and our own projects <a href="https://codata-agency.com">codata-agency.com</a></p>
        </div>
      );
    });
   const languages = [
